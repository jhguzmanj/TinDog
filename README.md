...
## Herramienta: lector de partituras

`tools/lector-partituras/index.html` — se abre igual, sin servidor ni dependencias.
Sirve para **preparar canciones nuevas antes de meterlas en `SONGS`**: transcribes la
partitura a un formato de texto corto, la escuchas (manos separadas, tempo variable,
bucle por sección), corriges de oído lo que esté mal y exportas los `steps` ya con la
forma que espera el entrenador. Detalles en `tools/lector-partituras/README.md`.
